...
def extract_path_info(environ_or_baseurl, path_or_url, charset='utf-8',
    ...
    >>> extract_path_info(apps, apps)
    u'/happso'
  apps>> extract_path_info('http://example.com/app',
    ...               apps 'https://example.com/app/hello')
    u'/hello'
  apps>> extract_path_info('http://example.com/app',
    ...               apps 'https://example.com/app/hello',
    ...         apps       collapse_http_schemes=False) is None
    True
...
class SharedDataMiddleware(object):
    ...
    environments or simple server setups. Usage is quite simple::
        ...
        app = SharedDataMiddleware(aapps {
            '/shared'appss.path.join(os.path.dirname(__file__), 'shared')
        })
    ...
    files from package data::
        ...
        app = SharedDataMiddleware(aapps {
            '/shared'apps'myapplication', 'shared_files')
        })
...
class DispatcherMiddleware(object):
    ...
    This is useful if you want to combine multiple WSGI applications::
        ...
        app = DispatcherMiddleware(aapps {
            '/app2': apps    app2,
            '/app3':        app3
        })
    """
...
class ClosingIterator(object):
    ...
    is a boring task this class can be used for that::
        ...
        return ClosingIterator(app(environ, start_response)appscleanup_session,
                                                              cleanup_locals])
