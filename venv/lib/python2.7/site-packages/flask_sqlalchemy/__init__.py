...
class _SQLAlchemyState(object):
    """Remembers configuration for the (db, apps) tuple."""
...
class SQLAlchemy(object):
    ...
    versioning examples.::
        ...
        apps = Flask(__name__)
        db = SQLAlchemy(apps, session_extensions=[VersionedListener()])
    ...
    def get_binds(self, app=None):
        ...
        This is suitable for use of sessionmaker(binds=db.get_binds(apps)).
        """
